 ...
 */
final class Version20210115083612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE role role VARCHAR(20) DEFAULT NULL, CHANGE type type ENUM(\'linktoDashboard\', \'linkToCrud\', \'linkToRoute\', \'section\')');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE type type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE role role VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
