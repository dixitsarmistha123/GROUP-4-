 ...
 */
final class Version20210115054430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD entity_path VARCHAR(100) NOT NULL, CHANGE type type ENUM(\'linktoDashboard\', \'linkToCrud\', \'linkToRoute\')');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu DROP entity_path, CHANGE type type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
