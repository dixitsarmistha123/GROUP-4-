 ...
 */
final class Version20210109053933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE post_status post_status ENUM(\'draft\', \'pending\', \'active\', \'inactive\', \'trashed\'), CHANGE post_type post_type ENUM(\'post\', \'page\')');
