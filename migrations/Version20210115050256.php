 ...
 */
final class Version20210115050256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE role role VARCHAR(20) NOT NULL, CHANGE type type ENUM(\'linkToDashboard\', \'linkToCrud\', \'linkToRoute\')');
